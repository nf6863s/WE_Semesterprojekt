<template>
  <div class="about">
    <h3>This Website was created as an Exam in Web-Engineering for the Summer-Semester of 2021 at the Hochschule Bonn-Rhein-Sieg</h3>
    <h5>Since i don't really know what else to put here, here is a very cool css animation i found on <a href="https://codepen.io/_fbrz/pen/whxbF" target="_blank">codepen</a>:</h5>
    <!--span>
      <pre style="text-align: left; width: fit-content; margin:auto">
                    ,----,
               ___.`      `,
       WOOF >  `===  D     :
                 `'.      .'
    ...
    <!-- This entire Book animation is not part of my examination. This was just inserted as a filler and because i wanted to showcase it. It can be found here: https://codepen.io/_fbrz/pen/whxbF -->
    <div id='book'>
      <div id='top'></div>
      <div id='front'></div>
      <div id='right'></div>
